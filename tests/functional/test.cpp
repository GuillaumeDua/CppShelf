...
namespace test::concepts {
    ...
    namespace ns = csl::functional::concepts;

    // simple_callable
    static_assert(ns::simple_callable<decltype(sample::lambda_const)>);
    static_assert(ns::simple_callable<decltype(sample::lambda_mutable)>);
    static_assert(ns::simple_callable<decltype(sample::lambda_const_noexcept)>);
    static_assert(ns::simple_callable<decltype(sample::func)>);
    static_assert(ns::simple_callable<decltype(sample::func_noexcept)>);
    static_assert(ns::simple_callable<decltype(&sample::user_defined_type::mem_func)>);
    static_assert(ns::simple_callable<decltype(&sample::user_defined_type::mem_func_noexcept)>);
    static_assert(ns::simple_callable<decltype(&sample::user_defined_type::mem_func_const)>);
    static_assert(ns::simple_callable<decltype(&sample::user_defined_type::mem_func_const_noexcept)>);
    static_assert(ns::simple_callable<decltype(&sample::user_defined_type::static_mem_func)>);
    static_assert(ns::simple_callable<decltype(&sample::user_defined_type::static_mem_func_noexcept)>);
