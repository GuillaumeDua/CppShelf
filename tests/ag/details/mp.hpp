...
namespace test::ag::details::mp::add_cv_ {
    static_assert(std::same_as<const int,   csl::ag::details::mp::add_cv_t<int>>);
    static_assert(std::same_as<const int&,  csl::ag::details::mp::add_cv_t<int&>>);
    static_assert(std::same_as<const int&&, csl::ag::details::mp::add_cv_t<int&&>>);

    static_assert(std::same_as<const int,   csl::ag::details::mp::add_cv_t<const int>>);
    static_assert(std::same_as<const int&,  csl::ag::details::mp::add_cv_t<const int&>>);
    static_assert(std::same_as<const int&&, csl::ag::details::mp::add_cv_t<const int&&>>);

    static_assert(std::same_as<volatile int,   csl::ag::details::mp::add_cv_t<int>>);
    static_assert(std::same_as<volatile int&,  csl::ag::details::mp::add_cv_t<int&>>);
    static_assert(std::same_as<volatile int&&, csl::ag::details::mp::add_cv_t<int&&>>);

    static_assert(std::same_as<volatile int,   csl::ag::details::mp::add_cv_t<volatile int>>);
    static_assert(std::same_as<volatile int&,  csl::ag::details::mp::add_cv_t<volatile int&>>);
    static_assert(std::same_as<volatile int&&, csl::ag::details::mp::add_cv_t<volatile int&&>>);
}