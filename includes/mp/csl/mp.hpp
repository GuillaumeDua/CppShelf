...
namespace csl::mp {
    ...
    template <typename T>
    constexpr inline bool is_pack_v = is_pack<T>::value;
    template <typename T>
    ...
    constexpr inline bool is_same_template_v = is_same_template<T, U>::value;
    template <typename T, typename U>
    ...
    template <template <typename ...> typename pack_type, typename T>
    constexpr inline bool is_instance_of_v = is_instance_of<pack_type, T>::value;
    template <template <typename ...> typename pack_type, typename T>
...
namespace csl::mp {
    ...
    template <std::size_t index, typename pack>
    constexpr inline std::size_t nth_v = nth_element_t<index, pack>::value;
#else
    // Indexed pack
    template <typename>
    struct pack_element;
    ...
    template <std::size_t I, typename T>
    constexpr inline std::size_t pack_element_v = I /*Note : equivalent to pack_element<I, T>::value;*/;

    template <std::size_t I, typename T>
    using nth_t = pack_element_t<I, T>;
    template <std::size_t I, typename T>
    constexpr inline std::size_t nth_v = pack_element_v<I, T>;

    template <typename T, typename pack_type>
    constexpr inline std::size_t index_of_v = pack_element<pack_type>::template index_of_<T>::index;
    ...
    template <typename ... Ts>
    constexpr inline bool is_template_with_ttps_v = is_template_with_ttps<Ts...>::value;
    ...
    template <typename ... Ts>
    constexpr inline bool is_template_with_nttps_v = is_template_with_nttps<Ts...>::value;
    ...
    template <typename ... Ts>
    constexpr inline bool is_template_v = is_template<Ts...>::value;
    ...
    template <typename ... ttps>
    constexpr inline std::size_t size_v = size<ttps...>::value;
    ...
    template <typename T, typename ... ttps>
    constexpr inline bool contains_v = contains<T, ttps...>::value;
    ...
    template <typename T, typename ... ttps>
    constexpr inline std::size_t count_v = count<T, ttps...>::value;
    ...
    template <typename T, typename ... Ts>
    constexpr inline std::size_t rindex_of_v = rindex_of<T, Ts...>::value;
    ...
    template <typename T, typename ... Ts>
    constexpr inline std::size_t index_of_v = index_of<T, Ts...>::value;

    template <typename T, typename ... Ts>
    using first_index_of = index_of<T, Ts...>;
    template <typename T, typename ... Ts>
    constexpr inline std::size_t  first_index_of_v = first_index_of<T, Ts...>::value;

    template <typename T, typename ... Ts>
    using last_index_of = rindex_of<T, Ts...>;
    template <typename T, typename ... Ts>
    constexpr inline std::size_t last_index_of_v = last_index_of<T, Ts...>::value;
#endif
