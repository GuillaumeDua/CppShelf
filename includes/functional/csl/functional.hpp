...
#endif
    template <typename ...>
    constexpr inline auto dependent_false_v = false;
}
...
namespace csl::functional::type_traits {
    ...
    constexpr inline bool is_invocable_v = is_invocable<T, arguments_type>::value;
    ...
    template <typename T, typename arguments_type>
    constexpr inline bool is_nothrow_invocable_v = is_nothrow_invocable<T, arguments_type>::value;
    ...
    template <typename R, typename F, typename arguments_type>
    constexpr inline bool is_invocable_r_v = is_invocable_r<R, F, arguments_type>::value;
    ...
    template <typename R, typename F, typename arguments_type>
    constexpr inline bool is_nothrow_invocable_r_v = is_nothrow_invocable_r<R, F, arguments_type>::value;
    ...
    > : std::true_type{};
    template <typename F>
    constexpr inline bool is_simple_callable_v = is_simple_callable<F>::value;
}
