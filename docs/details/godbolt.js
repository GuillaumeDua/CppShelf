...
class godbolt_snippet extends HTMLElement {
    ...
    load() {
        ...
        xhr.onload = function() {
            ...
            // code_node.style.borderRadius = 5 + 'px';
...
return generate_fun() + unicorns_everywhere<42>();`
            ...
            // todo: use send-to-godbolt-button instead
            //  - concatenate lines
            //  - use godbolt API
            //  - replace HTML elements by godbolt iframe
            let CE_button = document.createElement('button');
            CE_button.innerHTML =  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="20px" height="20px"><switch><g>
            ...
            CE_button.style.zIndex = 2;
            CE_button.style.position = 'absolute';
            CE_button.style.top = 10 + 'px';
            CE_button.style.right = 10 + 'px';
