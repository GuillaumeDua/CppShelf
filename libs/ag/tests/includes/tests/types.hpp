...
namespace test::ag::types {
    ...
    // NOLINTBEGIN(*-avoid-const-or-ref-data-members)
    struct field_ref_1 { int & i; };
    struct field_ref_2 { int & i; char && c; };
    struct field_ref_3 { int & i; char && c; char & cc; };
    // NOLINTEND(*-avoid-const-or-ref-data-members)
    ...
    // Deliberately has no std::formatter / fmt::formatter specialization:
    // guards against blanket formatter specializations reappearing.
