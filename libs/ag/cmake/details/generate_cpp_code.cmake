# Generates two headers into ${OUTPUT_DIR}/csl/ag/generated/:
#
#   configuration.hpp
...
#
#   configuration.hpp is included early (before fields_count).
#   to_tuple.hpp is included late (after make_tuple_view, inside namespace csl::ag::details::generated).
...
function(ag_generate_cpp_code)
    ...
    set(outdir "${arg_OUTPUT_DIR}/csl/ag/generated")
    file(MAKE_DIRECTORY "${outdir}")

    # --- configuration.hpp ---
    set(config_file "${outdir}/configuration.hpp")
    ...
    # --- to_tuple.hpp ---
    set(impl_file "${outdir}/to_tuple.hpp")
    message(STATUS "generating ${impl_file} ...")
    ...
    # --- to_tuple.hpp: make_to_tuple<N, T> ---
    ...
    # --- to_tuple.hpp: to_tuple_view_impl<N, T> ---
