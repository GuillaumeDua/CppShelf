...
namespace test::back_binder_ {
    ...
    consteval void copy() {
        ...
        {   // not_copiable, non-trivial move
            using not_copyable = csl::internal::test::types::semantic::not_copyable;
    ...
    consteval void move() {
        ...
        {   // not_moveable
            using not_moveable = csl::internal::test::types::semantic::not_moveable;
            auto f = not_moveable{};
...
namespace test::bind_back_ {
    ...
    consteval void usage_synthaxes() {
        using namespace csl::internal::test::types::semantic;
        using namespace csl::wf;
