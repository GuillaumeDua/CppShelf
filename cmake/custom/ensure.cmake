...
option(CSL_ENSURE__ENABLE_IOSTREAM_SUPPORT "[${CMAKE_PROJECT_NAME}::${component_name}]: enable iostream support" OFF)
...
option(CSL_ENSURE__ENABLE_FMT_SUPPORT "[${CMAKE_PROJECT_NAME}::${component_name}]: enable fmt support" OFF)
...
if (${CSL_ENSURE__ENABLE_FMT_SUPPORT})
    ...
    elseif(target fmt::fmt)
        ...
        message(ERROR "[${CMAKE_PROJECT_NAME}::${component_name}]: ill-formed fmt library")
    endif()
endif()
