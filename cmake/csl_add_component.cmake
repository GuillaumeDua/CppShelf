...
function(csl_add_component)
    ...
    if (EXISTS "${_csl_options_cmake}")
        message(VERBOSE "[${PROJECT_NAME}] csl::${csl_add_component_NAME} : loading options from ${_csl_options_cmake}")
    ...
    if (CSL_TEST_${csl_add_component_NAME})
        ...
        if (EXISTS "${_csl_tests_dir}/CMakeLists.txt")
            enable_testing()
            message(VERBOSE "[${PROJECT_NAME}] csl::${csl_add_component_NAME} (tests)")
            list(APPEND CMAKE_MESSAGE_INDENT "   ")
    ...
    if (CSL_EXAMPLE_${csl_add_component_NAME})
        ...
        if (EXISTS "${_csl_examples_dir}/CMakeLists.txt")
            message(VERBOSE "[${PROJECT_NAME}] csl::${csl_add_component_NAME} (example)")
            list(APPEND CMAKE_MESSAGE_INDENT "   ")
